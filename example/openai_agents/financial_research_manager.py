...
from openai_agents.helpers import get_mcp_agent
from openai_agents.models import (AnalysisSummary, FinancialSearchPlan,
...
class FinancialResearchManager:
    ...
    def __init__(self) -> None:
        ...
        self.planner_agent = get_mcp_agent(agent_name="FinancialPlannerAgent",
                                           prompt_name="planner_prompt", output_type=FinancialSearchPlan)
        self.search_agent = get_mcp_agent(agent_name="FinancialSearchAgent",
                                           prompt_name="search_prompt", output_type=FinancialSearchPlan)
